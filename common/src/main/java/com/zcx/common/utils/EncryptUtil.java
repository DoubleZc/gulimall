...
public class EncryptUtil {
	 ...
	 * 盐的长度
	 */
	public static final int SALT_BYTE_SIZE = 6 / 2;
	/**
	 * 生成密文的长度
	 */
	public static final int HASH_BIT_SIZE = 10 * 4;
	/**
	 * 迭代次数
	 */
	 ...
	 * @return: boolean
	 */
	private static boolean validPassword(String attemptedPassword, String encryptedPassword, String salt)
	 ...
	 */
	public static String getPassword(String password) throws NoSuchAlgorithmException, InvalidKeySpecException {
		//先获取盐值
	...
	public static boolean validatePassword(String originalPassword, String storedPassword)  {
		...
		String hash = parts[1];
		try {
			return EncryptUtil.validPassword(originalPassword, hash, salt);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return false;
